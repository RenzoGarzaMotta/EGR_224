...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Segment_Decoder_Score xil_defaultlib.Segment_Decoder_Score xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Segment_Decoder_Score -key {Behavioral:sim_1:Functional:Segment_Decoder_Score} -tclbatch cmd.tcl -protoinst "protoinst_files/Segment_Decoder_Score.protoinst" -protoinst "protoinst_files/Segment_Decoder_V_L.protoinst" -protoinst "protoinst_files/BTN_Debounce.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Segment_Decoder_Score.wdb xsim.dir)

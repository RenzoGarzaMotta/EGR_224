...
################################################################
# This is a generated script based on design: debounce
#
...
proc create_hier_cell_BTN_debounce { parentCell nameHier } {
  ...
  # Create instance: xup_nor5_0, and set properties
  set xup_nor5_0 [ create_bd_cell -type ip -vlnv xilinx.com:xup:xup_nor5:1.0 xup_nor5_0 ]
  set_property -dict [ list \
   CONFIG.DELAY {0} \
 ] $xup_nor5_0
  ...
  connect_bd_net -net xup_dff_3_q [get_bd_pins xup_dff_3/q] [get_bd_pins xup_nor5_0/a] [get_bd_pins xup_or2_1/b]
  connect_bd_net -net xup_dff_4_q [get_bd_pins xup_dff_4/q] [get_bd_pins xup_nor5_0/e] [get_bd_pins xup_or2_1/a]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_and2_3/a] [get_bd_pins xup_inv_0/y]

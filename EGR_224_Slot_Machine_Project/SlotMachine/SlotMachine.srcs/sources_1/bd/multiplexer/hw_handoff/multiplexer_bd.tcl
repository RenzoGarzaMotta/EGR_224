...
################################################################
# This is a generated script based on design: multiplexer
#
...
# Hierarchical cell: clk_divide_3Hz
proc create_hier_cell_clk_divide_3Hz { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_clk_divide_3Hz() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net xup_clk_divider_24_clkout [get_bd_pins clkout_0] [get_bd_pins xup_clk_divider_24/clkout]
...
# Hierarchical cell: clk_divide_1kHz
proc create_hier_cell_clk_divide_1kHz { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_clk_divide_1kHz() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net xup_clk_divider_14_clkout [get_bd_pins xup_clk_divider_14/clkout] [get_bd_pins xup_clk_divider_15/clkin]
  connect_bd_net -net xup_clk_divider_15_clkout [get_bd_pins xup_clk_divider_15/clkout] [get_bd_pins xup_clk_divider_16/clkin]
  connect_bd_net -net xup_clk_divider_16_clkout [get_bd_pins clkout_0] [get_bd_pins xup_clk_divider_16/clkout]
  connect_bd_net -net xup_clk_divider_1_clkout [get_bd_pins xup_clk_divider_1/clkout] [get_bd_pins xup_clk_divider_2/clkin]
  connect_bd_net -net xup_clk_divider_2_clkout [get_bd_pins xup_clk_divider_2/clkout] [get_bd_pins xup_clk_divider_3/clkin]
  connect_bd_net -net xup_clk_divider_3_clkout [get_bd_pins xup_clk_divider_3/clkout] [get_bd_pins xup_clk_divider_4/clkin]
  connect_bd_net -net xup_clk_divider_4_clkout [get_bd_pins xup_clk_divider_4/clkout] [get_bd_pins xup_clk_divider_5/clkin]
...
# Hierarchical cell: clk_divide_10Hz
proc create_hier_cell_clk_divide_10Hz { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_clk_divide_10Hz() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net xup_clk_divider_20_clkout [get_bd_pins xup_clk_divider_20/clkout] [get_bd_pins xup_clk_divider_21/clkin]
  connect_bd_net -net xup_clk_divider_21_clkout [get_bd_pins xup_clk_divider_21/clkout] [get_bd_pins xup_clk_divider_22/clkin]
  connect_bd_net -net xup_clk_divider_22_clkout [get_bd_pins clkout_0] [get_bd_pins xup_clk_divider_22/clkout]
  connect_bd_net -net xup_clk_divider_2_clkout [get_bd_pins xup_clk_divider_2/clkout] [get_bd_pins xup_clk_divider_3/clkin]
  connect_bd_net -net xup_clk_divider_3_clkout [get_bd_pins xup_clk_divider_3/clkout] [get_bd_pins xup_clk_divider_4/clkin]
  connect_bd_net -net xup_clk_divider_4_clkout [get_bd_pins xup_clk_divider_4/clkout] [get_bd_pins xup_clk_divider_5/clkin]
  connect_bd_net -net xup_clk_divider_5_clkout [get_bd_pins xup_clk_divider_5/clkout] [get_bd_pins xup_clk_divider_6/clkin]
...
# Hierarchical cell: Enable_Mux
proc create_hier_cell_Enable_Mux { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_Enable_Mux() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir O -from 0 -to 0 AN0
  create_bd_pin -dir O -from 0 -to 0 AN1
  create_bd_pin -dir O -from 0 -to 0 AN2
  create_bd_pin -dir O -from 0 -to 0 AN3
  ...
  # Create instance: xup_4_to_1_mux_vector_2, and set properties
  set xup_4_to_1_mux_vector_2 [ create_bd_cell -type ip -vlnv xilinx.com:xup:xup_4_to_1_mux_vector:1.0 xup_4_to_1_mux_vector_2 ]
  set_property -dict [ list \
   CONFIG.DELAY {0} \
   CONFIG.SIZE {1} \
 ] $xup_4_to_1_mux_vector_2

  # Create instance: xup_4_to_1_mux_vector_3, and set properties
  set xup_4_to_1_mux_vector_3 [ create_bd_cell -type ip -vlnv xilinx.com:xup:xup_4_to_1_mux_vector:1.0 xup_4_to_1_mux_vector_3 ]
  set_property -dict [ list \
   CONFIG.DELAY {0} \
   CONFIG.SIZE {1} \
 ] $xup_4_to_1_mux_vector_3

  # Create port connections
  connect_bd_net -net sel_0_1 [get_bd_pins sel_0] [get_bd_pins xup_4_to_1_mux_vector_0/sel] [get_bd_pins xup_4_to_1_mux_vector_1/sel] [get_bd_pins xup_4_to_1_mux_vector_2/sel] [get_bd_pins xup_4_to_1_mux_vector_3/sel]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_GND/dout] [get_bd_pins xup_4_to_1_mux_vector_0/a] [get_bd_pins xup_4_to_1_mux_vector_1/b] [get_bd_pins xup_4_to_1_mux_vector_2/c] [get_bd_pins xup_4_to_1_mux_vector_3/d]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_VCC/dout] [get_bd_pins xup_4_to_1_mux_vector_0/b] [get_bd_pins xup_4_to_1_mux_vector_0/c] [get_bd_pins xup_4_to_1_mux_vector_0/d] [get_bd_pins xup_4_to_1_mux_vector_1/a] [get_bd_pins xup_4_to_1_mux_vector_1/c] [get_bd_pins xup_4_to_1_mux_vector_1/d] [get_bd_pins xup_4_to_1_mux_vector_2/a] [get_bd_pins xup_4_to_1_mux_vector_2/b] [get_bd_pins xup_4_to_1_mux_vector_2/d] [get_bd_pins xup_4_to_1_mux_vector_3/a] [get_bd_pins xup_4_to_1_mux_vector_3/b] [get_bd_pins xup_4_to_1_mux_vector_3/c]
  connect_bd_net -net xup_4_to_1_mux_vector_0_y [get_bd_pins AN3] [get_bd_pins xup_4_to_1_mux_vector_0/y]
  connect_bd_net -net xup_4_to_1_mux_vector_1_y [get_bd_pins AN2] [get_bd_pins xup_4_to_1_mux_vector_1/y]
  connect_bd_net -net xup_4_to_1_mux_vector_2_y [get_bd_pins AN1] [get_bd_pins xup_4_to_1_mux_vector_2/y]
  connect_bd_net -net xup_4_to_1_mux_vector_3_y [get_bd_pins AN0] [get_bd_pins xup_4_to_1_mux_vector_3/y]
...
proc create_root_design { parentCell } {
  ...
  set AN0_0 [ create_bd_port -dir O -from 0 -to 0 AN0_0 ]
  set AN1_0 [ create_bd_port -dir O -from 0 -to 0 AN1_0 ]
  set AN2_0 [ create_bd_port -dir O -from 0 -to 0 AN2_0 ]
  set AN3_0 [ create_bd_port -dir O -from 0 -to 0 AN3_0 ]
  ...
  # Create instance: Enable_Mux
  create_hier_cell_Enable_Mux [current_bd_instance .] Enable_Mux
  ...
  create_hier_cell_clk_divide_10Hz [current_bd_instance .] clk_divide_10Hz

  # Create instance: clk_divide_1Hz
  create_hier_cell_clk_divide_1Hz [current_bd_instance .] clk_divide_1Hz

  # Create instance: clk_divide_1kHz
  create_hier_cell_clk_divide_1kHz [current_bd_instance .] clk_divide_1kHz

  # Create instance: clk_divide_3Hz
  create_hier_cell_clk_divide_3Hz [current_bd_instance .] clk_divide_3Hz
  ...
  # Create instance: xlslice_X0, and set properties
  set xlslice_X0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_X0 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {4} \
  ...
  # Create port connections
  connect_bd_net -net Enable_Mux_AN0 [get_bd_ports AN0_0] [get_bd_pins Enable_Mux/AN0]
  connect_bd_net -net Enable_Mux_AN1 [get_bd_ports AN1_0] [get_bd_pins Enable_Mux/AN1]
  connect_bd_net -net Enable_Mux_AN2 [get_bd_ports AN2_0] [get_bd_pins Enable_Mux/AN2]
  connect_bd_net -net Enable_Mux_AN3 [get_bd_ports AN3_0] [get_bd_pins Enable_Mux/AN3]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins xup_4_to_1_mux_vector_0/a]
  connect_bd_net -net c_counter_binary_1_Q [get_bd_pins c_counter_binary_1/Q] [get_bd_pins xup_4_to_1_mux_vector_0/b]
  connect_bd_net -net c_counter_binary_2_Q [get_bd_pins c_counter_binary_2/Q] [get_bd_pins xup_4_to_1_mux_vector_0/c]
  connect_bd_net -net c_counter_binary_3_Q [get_bd_pins c_counter_binary_3/Q] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net clk_divide_10Hz_NEEDS_EDIT_clkout_0 [get_bd_pins c_counter_binary_2/CLK] [get_bd_pins clk_divide_10Hz/clkout_0]
  connect_bd_net -net clk_divide_1Hz_clkout_0 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_divide_1Hz/clkout_0]
  connect_bd_net -net clk_divide_1kHz_NEEDS_EDIT_clkout_0 [get_bd_pins c_counter_binary_3/CLK] [get_bd_pins clk_divide_1kHz/clkout_0]
  connect_bd_net -net clk_divide_3Hz_NEEDS_EDIT_clkout_0 [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins clk_divide_3Hz/clkout_0]
  connect_bd_net -net clk_in_1 [get_bd_ports clkin] [get_bd_pins clk_divide_10Hz/clkin_0] [get_bd_pins clk_divide_1Hz/clkin_0] [get_bd_pins clk_divide_1kHz/clkin_0] [get_bd_pins clk_divide_3Hz/clkin_0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins xup_4_to_1_mux_vector_0/d]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins Enable_Mux/sel_0] [get_bd_pins xlslice_0/Dout] [get_bd_pins xup_4_to_1_mux_vector_0/sel]
  connect_bd_net -net xlslice_X0_Dout [get_bd_pins Seg_Decoder/X0] [get_bd_pins xlslice_X0/Dout]
  connect_bd_net -net xlslice_X1_Dout [get_bd_pins Seg_Decoder/X1] [get_bd_pins xlslice_X1/Dout]
  connect_bd_net -net xlslice_X2_Dout [get_bd_pins Seg_Decoder/X2] [get_bd_pins xlslice_X2/Dout]
  connect_bd_net -net xlslice_X3_Dout [get_bd_pins Seg_Decoder/X3] [get_bd_pins xlslice_X3/Dout]
  connect_bd_net -net xup_4_to_1_mux_vector_0_y1 [get_bd_pins xlslice_X0/Din] [get_bd_pins xlslice_X1/Din] [get_bd_pins xlslice_X2/Din] [get_bd_pins xlslice_X3/Din] [get_bd_pins xup_4_to_1_mux_vector_0/y]

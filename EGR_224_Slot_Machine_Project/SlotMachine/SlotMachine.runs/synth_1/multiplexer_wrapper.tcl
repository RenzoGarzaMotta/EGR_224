...
synth_design -top multiplexer_wrapper -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef multiplexer_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file multiplexer_wrapper_utilization_synth.rpt -pb multiplexer_wrapper_utilization_synth.pb"

...
HD_PWD='C:/Users/garzamor/EGR224/EGR_224_Slot_Machine_Project/SlotMachine/SlotMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplexer_wrapper.tcl

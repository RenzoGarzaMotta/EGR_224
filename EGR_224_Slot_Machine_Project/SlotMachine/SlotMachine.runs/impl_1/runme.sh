...
HD_PWD='C:/Users/garzamor/EGR224/EGR_224_Slot_Machine_Project/SlotMachine/SlotMachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplexer_wrapper.tcl -notrace

...
#
# Generated by export_simulation on Sun Feb 23 22:58:19 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './Win_Conditions.sh' script.

./Win_Conditions.sh -reset_run
...
./Win_Conditions.sh -noclean_files

For more information on the script, please type './Win_Conditions.sh -help'.

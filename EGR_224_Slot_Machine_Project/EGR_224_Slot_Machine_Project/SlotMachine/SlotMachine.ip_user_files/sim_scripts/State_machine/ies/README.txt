...
#
# Generated by export_simulation on Sun Feb 23 16:28:20 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './State_machine.sh' script.

./State_machine.sh -reset_run
...
./State_machine.sh -noclean_files

For more information on the script, please type './State_machine.sh -help'.

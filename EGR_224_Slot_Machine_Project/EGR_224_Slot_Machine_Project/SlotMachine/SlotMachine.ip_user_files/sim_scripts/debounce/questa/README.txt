...
#
# Generated by export_simulation on Sat Feb 22 22:07:09 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './debounce.sh' script.

./debounce.sh -reset_run
...
./debounce.sh -noclean_files

For more information on the script, please type './debounce.sh -help'.

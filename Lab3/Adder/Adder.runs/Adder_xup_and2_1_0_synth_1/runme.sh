...
HD_PWD='C:/Users/vonehrka/EGR_224-master/EGR_224-master/Lab3/Adder/Adder.runs/Adder_xup_and2_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_xup_and2_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_xup_and2_1_0.tcl

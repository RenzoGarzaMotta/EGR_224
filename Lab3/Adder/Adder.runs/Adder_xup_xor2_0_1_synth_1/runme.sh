...
HD_PWD='C:/Users/vonehrka/EGR_224-master/EGR_224-master/Lab3/Adder/Adder.runs/Adder_xup_xor2_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_xup_xor2_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_xup_xor2_0_1.tcl

...
HD_PWD='W:/EGR_224/Lab3/Adder/Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder_wrapper.tcl -notrace

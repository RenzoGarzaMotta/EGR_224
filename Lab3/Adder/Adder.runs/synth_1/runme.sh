...
HD_PWD='C:/EGR_224/Lab3/Adder/Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_wrapper.tcl

...
module Adder
   (A_bus,
    ...
    Cout_0,
    SUM);
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.A_BUS DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.A_BUS, LAYERED_METADATA undef" *) input A_bus;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.B_BUS DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.B_BUS, LAYERED_METADATA undef" *) input B_Bus;
  output Cout_0;
  ...
  assign A_bus_1 = A_bus;
  assign B_Bus_1 = B_Bus;

...
HD_PWD='C:/Users/garzamor/EGR224/EGR_224_Slot_Machine_Project/SlotMachine/SlotMachine.runs/multiplexer_xup_clk_divider_11_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_xup_clk_divider_11_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplexer_xup_clk_divider_11_1.tcl

...
HD_PWD='C:/Users/vonehrka/EGR_224-master/EGR_224-master/Lab3/Adder/Adder.runs/Adder_xup_or2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_xup_or2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_xup_or2_0_0.tcl

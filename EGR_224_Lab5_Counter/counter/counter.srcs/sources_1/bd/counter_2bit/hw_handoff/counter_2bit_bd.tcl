...
################################################################
# This is a generated script based on design: counter_2bit
#
...
# source counter_2bit_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net xup_dff_en_reset_0_q [get_bd_pins xlconcat_0/In1] [get_bd_pins xup_dff_en_reset_0/q] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net xup_dff_en_reset_1_q [get_bd_pins xlconcat_0/In0] [get_bd_pins xup_dff_en_reset_1/q] [get_bd_pins xup_inv_0/a] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_dff_en_reset_1/d] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_xor2_0_y [get_bd_pins xup_dff_en_reset_0/d] [get_bd_pins xup_xor2_0/y]

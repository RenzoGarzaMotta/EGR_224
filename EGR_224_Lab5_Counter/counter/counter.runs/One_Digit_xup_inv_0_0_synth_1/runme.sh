...
HD_PWD='C:/Users/garzamor/EGR224/EGR_224_Lab5_/counter/counter.runs/One_Digit_xup_inv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log One_Digit_xup_inv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source One_Digit_xup_inv_0_0.tcl

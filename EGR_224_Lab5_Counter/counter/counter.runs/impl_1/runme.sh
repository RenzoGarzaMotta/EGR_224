...
HD_PWD='C:/Users/garzamor/EGR224/EGR_224_Lab5_/counter/counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log One_Digit_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source One_Digit_wrapper.tcl -notrace

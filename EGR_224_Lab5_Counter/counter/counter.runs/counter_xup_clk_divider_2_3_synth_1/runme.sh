...
HD_PWD='C:/Users/garzamor/EGR224/EGR_224_Lab5_/counter/counter.runs/counter_xup_clk_divider_2_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_xup_clk_divider_2_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_xup_clk_divider_2_3.tcl

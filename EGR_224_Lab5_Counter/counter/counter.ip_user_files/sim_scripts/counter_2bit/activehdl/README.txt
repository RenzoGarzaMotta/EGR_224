...
#
# Generated by export_simulation on Sun Feb 02 16:06:34 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './counter_2bit.sh' script.

./counter_2bit.sh -reset_run
...
./counter_2bit.sh -noclean_files

For more information on the script, please type './counter_2bit.sh -help'.

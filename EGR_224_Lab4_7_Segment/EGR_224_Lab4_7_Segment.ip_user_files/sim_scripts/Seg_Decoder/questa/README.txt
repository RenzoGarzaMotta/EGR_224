...
#
# Generated by export_simulation on Thu Jan 30 21:36:15 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './Seg_Decoder.sh' script.

./Seg_Decoder.sh -reset_run
...
./Seg_Decoder.sh -noclean_files

For more information on the script, please type './Seg_Decoder.sh -help'.

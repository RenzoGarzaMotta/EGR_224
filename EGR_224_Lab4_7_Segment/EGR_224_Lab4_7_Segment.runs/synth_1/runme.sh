...
HD_PWD='C:/Users/vonehrka/EGR_224/EGR_224_Lab4_7_Segment/EGR_224_Lab4_7_Segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seg_Decoder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seg_Decoder_wrapper.tcl

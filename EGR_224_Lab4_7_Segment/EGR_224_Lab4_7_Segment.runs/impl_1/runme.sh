...
HD_PWD='C:/Users/vonehrka/EGR_224/EGR_224_Lab4_7_Segment/EGR_224_Lab4_7_Segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seg_Decoder_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seg_Decoder_wrapper.tcl -notrace
